...
* *Controls* - This tab exposes the configuration of the 3 differents monitorings and this is where you can start and stop each one of them !http://github.com/pjaton/LocationTester/raw/master/README-Controls.png!
* *Logs* - This tab show you the monitoring logs and it let you reset the logs or email it to yourself !http://github.com/pjaton/LocationTester/raw/master/README-Logs.png!
